...
const sampleMails = [
  {
    ...
    time: "2h ago",
    content:
      "Hello! Your enrollment for the Spring 2026 semester has been confirmed. You can view your updated class schedule in the student portal.",
    starred: false,
  },
  {
    id: 2,
    sender: "Student Affairs",
    subject: "🎉 Workshop: Boost Your Study Skills",
    time: "1d ago",
    content:
      "Join our Study Skills Workshop on November 18th. Learn note-taking hacks, better time management, and tips for acing finals!",
    starred: true,
  },
  {
    id: 3,
    ...
    time: "3d ago",
    content:
      "The student portal will undergo maintenance on November 12th from 1:00 AM to 3:00 AM UTC. Access may be limited during this time.",
    starred: false,
  },
  {
    id: 4,
    ...
    time: "4d ago",
    content:
      "Your borrowed book 'Introduction to Data Science' is due on November 11th. Please return or renew it to avoid late fees.",
    starred: false,
  },
  {
    id: 5,
    sender: "Professor Martinez",
    subject: "Assignment Feedback Uploaded",
    time: "5d ago",
    content:
      "Your feedback for the Machine Learning Assignment #2 is now available. Check the course dashboard for comments and grades.",
    starred: false,
  },
];
